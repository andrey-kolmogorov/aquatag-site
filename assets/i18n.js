...
(function () {
  const DICT = {
    ...
    'terms.s3.p1':      { en: 'Physical kits ship from the EU (currently Austria). Standard shipping is 3–7 business days within the EU and 7–14 for international orders. We cover postage on orders over €50.', de: 'Physische Kits versenden wir aus der EU (derzeit Österreich). Standardversand 3–7 Werktage innerhalb EU, 7–14 international. Ab 50 € übernehmen wir das Porto.' },
    ...
    'terms.s8.p1':      { en: 'These terms are governed by Austrian law. Disputes go to the competent courts in Austria. EU consumer protections apply if you are a consumer in the EU.', de: 'Es gilt österreichisches Recht. Gerichtsstand ist Österreich. Verbraucherrechte in der EU bleiben unberührt.' },
    ...
    // ─────────── SUPPORT ───────────
    'sup.title':        { en: 'Aquatag — Support', de: 'Aquatag — Support' },
    'sup.eyebrow':      { en: 'Help · Support', de: 'Hilfe · Support' },
    'sup.h1.html':      { en: 'How can we <em>help?</em>', de: 'Wie können wir <em>helfen?</em>' },
    'sup.lead':         { en: 'Aquatag is a small iOS app and a small box of stickers, run by a two-person studio. If something isn’t working, or you just have a question, write to us — we read every email and reply within a day or two.', de: 'Aquatag ist eine kleine iOS-App und eine kleine Kiste Sticker, betrieben von einem Zwei-Personen-Studio. Wenn etwas hakt oder du eine Frage hast: schreib uns — wir lesen jede E-Mail und antworten innerhalb von ein bis zwei Tagen.' },
    'sup.stat1':        { en: 'Email response, target', de: 'E-Mail-Antwortzeit, Ziel' },
    'sup.stat2':        { en: 'Day return window', de: 'Tage Rückgaberecht' },
    'sup.stat3':        { en: 'Time zone (Vienna)', de: 'Zeitzone (Wien)' },
    'sup.toc1':         { en: 'Getting started', de: 'Erste Schritte' },
    'sup.toc2':         { en: 'Plants & watering', de: 'Pflanzen & Gießen' },
    'sup.toc3':         { en: 'Stickers & NFC', de: 'Sticker & NFC' },
    'sup.toc4':         { en: 'Reminders', de: 'Erinnerungen' },
    'sup.toc5':         { en: 'Home Assistant', de: 'Home Assistant' },
    'sup.toc6':         { en: 'Troubleshooting', de: 'Fehlersuche' },
    'sup.toc7':         { en: 'Orders & returns', de: 'Bestellungen & Rückgabe' },
    'sup.toc8':         { en: 'Contact', de: 'Kontakt' },
    'sup.s1.h':         { en: 'Getting started', de: 'Erste Schritte' },
    'sup.s1.p1':        { en: 'Install Aquatag from the App Store, open it, and tap the plus button to add your first plant. Give it a name, pick a character, and choose how often it needs watering. That’s the entire onboarding — there is no account to create.', de: 'Aquatag im App Store installieren, öffnen, und auf den Plus-Button tippen, um die erste Pflanze hinzuzufügen. Name vergeben, Charakter wählen, Gieß-Intervall festlegen. Das ist das komplette Onboarding — ein Konto musst du nicht erstellen.' },
    'sup.s1.p2':        { en: 'Aquatag works fully offline. The app is free and contains no in-app purchases.', de: 'Aquatag funktioniert vollständig offline. Die App ist kostenlos und enthält keine In-App-Käufe.' },
    'sup.s2.h':         { en: 'Plants & watering', de: 'Pflanzen & Gießen' },
    'sup.s2.p1':        { en: 'Tap a plant to log a watering — the timer resets and the next reminder is scheduled. To edit a plant’s name, character, or interval, open it and tap Edit. To delete a plant, swipe left in the plant list.', de: 'Tippe eine Pflanze an, um ein Gießen zu protokollieren — der Timer wird zurückgesetzt und die nächste Erinnerung geplant. Name, Charakter oder Intervall änderst du über Bearbeiten in der Pflanzendetailansicht. Pflanze löschen: in der Liste nach links wischen.' },
    'sup.s2.p2':        { en: 'You can change a watering interval at any time. Past watering events are kept and visible in the history view.', de: 'Das Gieß-Intervall kannst du jederzeit ändern. Vergangene Gieß-Ereignisse bleiben erhalten und sind in der Verlaufsansicht sichtbar.' },
    'sup.s3.h':         { en: 'Stickers & NFC', de: 'Sticker & NFC' },
    'sup.s3.p1':        { en: 'Each kit contains six waterproof NFC stickers, one per character. To bind a sticker to a plant, open the plant in the app, tap Link sticker, and hold your iPhone close to the sticker until it confirms. After that, a tap on the sticker opens the plant and lets you log a watering in one motion.', de: 'Jedes Kit enthält sechs wasserfeste NFC-Sticker, einen je Charakter. Um einen Sticker einer Pflanze zuzuweisen: Pflanze öffnen, Sticker verknüpfen tippen und das iPhone an den Sticker halten, bis bestätigt wird. Danach öffnet ein Tippen auf den Sticker die Pflanze und protokolliert das Gießen in einem Schritt.' },
    'sup.s3.p2':        { en: 'NFC works on all iPhones from iPhone 7 onwards. Older iPads do not have the necessary chip — the app still works, you just won’t be able to use the tap shortcut.', de: 'NFC funktioniert auf allen iPhones ab iPhone 7. Ältere iPads haben den nötigen Chip nicht — die App funktioniert trotzdem, du kannst nur die Tipp-Abkürzung nicht nutzen.' },
    'sup.s4.h':         { en: 'Reminders & notifications', de: 'Erinnerungen & Benachrichtigungen' },
    'sup.s4.p1':        { en: 'Aquatag schedules a local notification when each plant is due. Notifications are off until you allow them in iOS — go to Settings → Aquatag → Notifications if you missed the prompt during onboarding.', de: 'Aquatag plant lokale Benachrichtigungen, wenn eine Pflanze fällig ist. Standardmäßig sind Benachrichtigungen aus, bis du sie in iOS erlaubst — falls du die Abfrage beim Start verpasst hast: Einstellungen → Aquatag → Mitteilungen.' },
    'sup.s4.p2':        { en: 'You can snooze a reminder by 1 day from the notification itself, or change quiet hours per device under Settings → Notifications inside the app.', de: 'Eine Erinnerung kannst du direkt aus der Mitteilung um einen Tag verschieben. Ruhezeiten je Gerät: in der App unter Einstellungen → Mitteilungen.' },
    'sup.s5.h':         { en: 'Home Assistant sync', de: 'Home-Assistant-Sync' },
    'sup.s5.p1':        { en: 'The Home Assistant integration is optional and entirely under your control. We do not operate any servers in this path. To enable it, generate a long-lived access token in your Home Assistant profile and paste it into Settings → Home Assistant inside the app. Each watering event is then sent as a single REST call to your instance.', de: 'Die Home-Assistant-Integration ist optional und liegt vollständig in deiner Hand. Auf diesem Weg betreiben wir keinerlei Server. Aktivieren: Long-Lived-Access-Token in deinem Home-Assistant-Profil erzeugen und in der App unter Einstellungen → Home Assistant einfügen. Jedes Gieß-Ereignis wird dann als ein REST-Aufruf an deine Instanz gesendet.' },
    'sup.s5.p2.html':   { en: 'Details on what is sent live in the <a href="privacy.html#ha">privacy policy</a>.', de: 'Was genau gesendet wird, steht in der <a href="privacy.html#ha">Datenschutzerklärung</a>.' },
    'sup.s6.h':         { en: 'Troubleshooting', de: 'Fehlersuche' },
    'sup.s6.l1.html':   { en: '<b>Notifications don’t arrive.</b> Check iOS Settings → Aquatag → Notifications. Focus modes and Low Power Mode can also delay or silence them.', de: '<b>Benachrichtigungen kommen nicht.</b> Prüfe iOS-Einstellungen → Aquatag → Mitteilungen. Auch Fokus-Modi und Stromsparmodus können sie verzögern oder unterdrücken.' },
    'sup.s6.l2.html':   { en: '<b>NFC tap doesn’t open the app.</b> Make sure the sticker is bound to a plant (Plant → Link sticker). Hold the top of the iPhone over the sticker for a full second.', de: '<b>NFC-Tipp öffnet die App nicht.</b> Stelle sicher, dass der Sticker einer Pflanze zugewiesen ist (Pflanze → Sticker verknüpfen). Das obere Ende des iPhones eine ganze Sekunde an den Sticker halten.' },
    'sup.s6.l3.html':   { en: '<b>A plant is missing after restoring a backup.</b> Aquatag stores everything in iCloud Backup if you have it enabled. Restore the backup from iOS Settings → Apple ID → iCloud and the data will return.', de: '<b>Eine Pflanze fehlt nach dem Wiederherstellen eines Backups.</b> Aquatag speichert alles im iCloud-Backup, sofern aktiviert. Backup wiederherstellen via iOS-Einstellungen → Apple-ID → iCloud, und die Daten kommen zurück.' },
    'sup.s6.l4.html':   { en: '<b>Home Assistant says the call failed.</b> Most often the access token has expired or the URL is wrong. Re-paste both under Settings → Home Assistant.', de: '<b>Home Assistant meldet einen Fehler.</b> Meist ist der Access-Token abgelaufen oder die URL falsch. Beides unter Einstellungen → Home Assistant erneut einfügen.' },
    'sup.s7.h':         { en: 'Orders & returns', de: 'Bestellungen & Rückgabe' },
    'sup.s7.p1':        { en: 'Sticker kits ship from Austria within 1–2 business days. Standard shipping takes 3–7 days inside the EU and 7–14 days internationally. Orders over €50 ship free.', de: 'Sticker-Kits versenden wir aus Österreich innerhalb 1–2 Werktagen. Standardversand: 3–7 Tage innerhalb EU, 7–14 Tage international. Ab 50 € versandkostenfrei.' },
    'sup.s7.p2':        { en: 'You can return a kit within 30 days for a full refund — no forms, no questions. If a sticker peels within 12 months of normal use, write to us and we’ll send a replacement.', de: 'Du kannst ein Kit innerhalb von 30 Tagen vollständig zurückgeben — keine Formulare, keine Fragen. Löst sich ein Sticker binnen 12 Monaten bei normaler Nutzung, melde dich — wir schicken Ersatz.' },
    'sup.s8.h':         { en: 'Contact', de: 'Kontakt' },
    'sup.s8.p1.html':   { en: 'For app help, sticker questions, or order issues, email <a href="mailto:support@aquatag.app">support@aquatag.app</a>. We aim to reply within one business day in CET.', de: 'Für App-Hilfe, Sticker-Fragen oder Bestellanliegen: <a href="mailto:support@aquatag.app">support@aquatag.app</a>. Wir antworten in der Regel innerhalb eines Werktags (MEZ).' },
    'sup.s8.p2.html':   { en: 'Privacy questions go to <a href="mailto:privacy@aquatag.app">privacy@aquatag.app</a>; everything else can go to <a href="mailto:hello@aquatag.app">hello@aquatag.app</a>.', de: 'Datenschutzfragen an <a href="mailto:privacy@aquatag.app">privacy@aquatag.app</a>; alles andere gerne an <a href="mailto:hello@aquatag.app">hello@aquatag.app</a>.' },
    ...
    'nu.app.h.html':       { en: 'Now <em>on the<br>App Store.</em>', de: 'Jetzt <em>im<br>App Store.</em>' },
    'nu.app.p':            { en: 'Free, no accounts, no ads, no in-app purchases. Available in 175 countries on iPhone and iPad.', de: 'Kostenlos, keine Konten, keine Werbung, keine In-App-Käufe. In 175 Ländern für iPhone und iPad.' },
    'nu.app.qr':           { en: 'Scan to open on iPhone', de: 'Mit dem iPhone scannen' },
