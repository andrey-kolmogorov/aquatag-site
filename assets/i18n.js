...
(function () {
  const DICT = {
    ...
    'nu.cta.h.html':       { en: 'Order a<br><em>set of seven.</em>', de: 'Ein <em>Siebener-<br>Set</em> bestellen.' },
    ...
    'tr.cast.sub':         { en: 'Seven hand-drawn characters, each on a waterproof NTAG213 sticker. They live on the pot, forever, even when you\u2019re travelling.', de: 'Sieben handgezeichnete Charaktere, jeder auf einem wasserfesten NTAG213-Sticker. Sie bleiben am Topf — auch wenn du verreist bist.' },
